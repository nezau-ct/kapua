...
public class KeycloakOpenIDServiceTest extends Assert {
    ...
    public void getAuthUriNullConfigurationTest() throws OpenIDIllegalArgumentException {
        keycloakOpenIDService.getAuthUri();
    }
    ...
    @Test(expected = OpenIDIllegalArgumentException.class)
    public void getTokenUriNullConfigurationTest() throws OpenIDIllegalArgumentException {
        System.clearProperty("sso.openid.keycloak.uri");
        System.clearProperty("sso.openid.keycloak.realm");
        keycloakOpenIDService.getTokenUri();
    }
    ...
    public void getLogoutUriTest() throws OpenIDIllegalArgumentException {
        ...
        assertEquals("Expected and actual values should be the same.", "foobar.com/auth/realms/my-realm/protocol/openid-connect/logout", keycloakOpenIDService.getLogoutUri());

    }

    @Test(expected = OpenIDIllegalArgumentException.class)
    public void getLogoutUriNullConfigurationTest() throws OpenIDIllegalArgumentException {
        System.clearProperty("sso.openid.keycloak.uri");
        System.clearProperty("sso.openid.keycloak.realm");
        keycloakOpenIDService.getLogoutUri();
    }
}